...
\def \authorabstract{Kamal, Naheel, F.}
...
\abstract{
  [LAST NAME, FIRST NAME, MIDDLE INITIAL.], [Masters/Doctorate] : [January/June] : [Year], [Degree / Program Type] \\
  \noindent Title: [Type Title in Title Case [Initial Caps]: Do Not Capitalize Coordinating Conjunctions [and, but, for, nor, or, so, yet], Prepositions, and Articles] \\
  \noindent Supervisor of [Thesis/Dissertation]: [Advisor’s First Name, Middle Initial, Last name only].
