...
** Is this usable?
   Some students confirmed submitting using this template for Spring and Fall 2020. So, probably yes. If anything is wrong TAD would reply specifying their comments. If they do and you don't know how to fix it, start an issue here.
